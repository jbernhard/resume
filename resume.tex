...
\newcommand{\icon}[1]{{\color[gray]{.5}\faIcon{#1}\enspace}}

\begin{center}
  {\huge\raleway Jonah E.\ Bernhard \\[1ex]}
  \icon{globe}\href{https://jbernhard.xyz}{jbernhard.xyz}
  \qquad
  \icon{envelope}\href{mailto:jonah.bernhard@gmail.com}{jonah.bernhard@gmail.com}
  \qquad
  \icon{github}\href{https://github.com/jbernhard}{jbernhard}
\end{center}
